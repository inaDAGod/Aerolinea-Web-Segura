                ...
                .then(data => {
                    ...
                    if(data.password_expired) {
                        ...
                        if(data.tipo_usuario === 'cliente'){
                            window.location.href = window.location.origin + '/public/indexCliente.html';
                        }
                        else if(data.tipo_usuario === 'administrador'){
                            window.location.href = window.location.origin + '/public/indexAdmi.html';;
                        }
            ...
            .then(data => {
                if(data && data.estado === "contraseña_cambiada") {
                    Swal.fire({
                        ...
                        window.location.href = window.location.origin + '/public/registro.html';
                    });
